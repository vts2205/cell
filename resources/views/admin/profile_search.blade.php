...
<div class="mb-5">
    <div class="float-right pb-3">
    	<form class="d-none d-sm-inline-block" method="get" action="{{url('/admin/profile/search')}}">
     	...
     	<a href="?view=grid" class="btn btn-gradient-info pull-right px-3" ><i class="fa fa-th"></i></a>
     	<a href="?view=list" class="btn btn-gradient-info pull-right px-3" ><i class="fa fa-list"></i></a>
        <a href="/admin/users/create" class="btn btn-gradient-info pull-right px-3"><i class="fa fa-user-plus"></i></a>
     </div>
     <div lass="float-left">
     	<h4>Users</h4>
     </div>
...
<div class="container msg">
      {{ $profile->appends(request()->query())->links('layouts.pagination') }}
</div>
<div class="row ">
                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <table class="table">
                      ...
                      <tbody>
                        @php  
              			$pageData=json_decode($profile->toJson());
